...
export function registerTriage(program: Command): void {
  program
    .command('triage')
    .description(
      'Walk un-triaged Conductor Requests and assist decomposition into Conductor Task / ' +
        'Conductor Ordered Task. Always ends with a human confirming before Jira is written to.',
    )
